...
const Chat = ({ chatId, userId, userName = '', userAvatar = '', otherUserName = 'Khaled Saeed', otherUserAvatar = 'https://picsum.photos/200', headerComponent, containerStyle, placeholder = 'Type a message', showCamera = true, showGallery = true, onBackPress, onCallPress, orderId = '6849cbbf4264200046301370', }) => {
    ...
    const renderCustomHeader = () => {
        ...
        <react_native_1.TouchableOpacity style={styles.backButton} onPress={onBackPress}>
          <react_native_1.Image source={require('../img/chevron-left.png')}/>
        </react_native_1.TouchableOpacity>

        {otherUserAvatar && (<react_native_1.View style={styles.headerProfile}>
            <react_native_1.Image source={{ uri: otherUserAvatar }} style={styles.headerAvatar}/>
            <react_native_1.Text style={styles.headerName}>{otherUserName}</react_native_1.Text>
          </react_native_1.View>)}
